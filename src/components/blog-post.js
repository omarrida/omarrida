    ...
    <div className={"flex items-center p-8 pt-0"}>
      <div className="max-w-sm w-full lg:max-w-full">
        <a href={medium} target="_blank">
          <div
            className="lg:w-2/3 shadow border-r border-b border-l border-t border-gray-400 lg:border-l lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            <div>
